...
object FunctionalGeometry {
  ...
  def blank(m: Int = 4, n: Int = 4): Image = rectangle(16,16).scale(m.toDouble, n.toDouble).noStroke
  ...
  val side1: Image = quartet(blank(), blank(), t.scale(2,2).rotate(90.degrees), t.scale(2,2))
  ...
  val corner2: Image = quartet(corner1, side1, side1 rotate 90.degrees, u.scale(4,4))

  val pseudocorner: Image =
    quartet(corner2, side2, side2 rotate 90.degrees, (t rotate 90.degrees).scale(8,8))
  ...
  val corner: Image = nonet(corner2, side2, side2,
                            side2 rotate 90.degrees, u.scale(8,8), (t rotate 90.degrees).scale(8,8),
                            side2 rotate 90.degrees, (t rotate 90.degrees).scale(8,8), (q rotate 90.degrees).scale(16,16).at(0,-128))
