...
Paths allow construction of custom shapes. They are described in [their own section](../pictures/path.md). There are three methods on the `Image` companion object that deal with paths:
