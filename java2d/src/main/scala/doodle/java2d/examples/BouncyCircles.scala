      ...
      .map {
        case (r1, r2, r3, r4, r5, r6) =>
          circle[Algebra, Drawing](r1 * 85 + 10)
            ...
            .at(r1 * 400 - 200, 250)
            .on(circle[Algebra, Drawing](r2 * 85 + 10)
              .strokeColor(Color.magenta.spin(170.degrees))
              .at(r2 * 400 - 200, 150))
            .on(circle[Algebra, Drawing](r3 * 85 + 10)
              .strokeColor(Color.magenta.spin(140.degrees))
              .at(r3 * 400 - 200, 50))
            .on(circle[Algebra, Drawing](r4 * 85 + 10)
              .strokeColor(Color.magenta.spin(150.degrees))
              .at(r4 * 400 - 200, -50))
            .on(circle[Algebra, Drawing](r5 * 85 + 10)
              .strokeColor(Color.magenta.spin(140.degrees))
              .at(r5 * 400 - 200, -150))
            .on(circle[Algebra, Drawing](r6 * 85 + 10)
