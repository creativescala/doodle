...
This is the development branch of Doodle. The current release is **`0.9.3-SNAPSHOT`**. The `master` branch has the released version.
...
libraryDependencies += "creativescala.org" %% "doodle" % "0.9.3-SNAPSHOT"
~~~
