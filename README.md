...
You can use Doodle in your own project by importing the JARs published to our [Bintray repository][bintray-training]. The current release is **`0.6.0`**. To use it add the following to your `build.sbt`:
...
libraryDependencies += "underscoreio" %% "doodle" % "0.6.0"
~~~
